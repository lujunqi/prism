...
//				System.out.println(this+"[游标][131]"+(t2-t1));
	 ...
	 */
	public List<Map<String,Object>> getListColValue(String sql,int maxnum)throws SQLException{
	...
	public List<Map<String,Object>> getListColValue(String sql,int minnum,int maxnum)throws SQLException{
		ResultSet rs = getResultSet(sql);
	...
	public List<Map<String,Object>> getListFormRs(ResultSet rs,int maxnum)throws SQLException{
		return getListFormRs(rs,0,maxnum);
	}
	public List<Map<String,Object>> getListFormRs(ResultSet rs,int minnum,int maxnum)throws SQLException{
